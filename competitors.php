...
<head>
	...
	<script type="text/javascript" src="competitors/js/competitors.js"></script>
	<script type="text/javascript" src="competitors/js/comment.js"></script>
</head>
<body>
	<div id="canvas">
		<div id="main">
		<div id="topstripe"></div>
			...
			<div id="content">
				...
				<h1>Works of competitors</h1>
				<div id="competitorscontent"><script type="text/javascript">Competitors.startObserving();</script></div>
			</div>
			<div id="footer">
				<p>
